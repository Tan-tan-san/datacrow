...
CMD ["java", "-Xmx1024m", "-jar", "/datacrow/dc-server/datacrow-server.jar", "-dir:", "/datacrow/dc-server/datacrow-server.jar", "-userdir:", "/datacrow, "-port:", "9000", "-imageserverport:", "9001", "-webserverport:", "8080", "-credentials:", "admin/2xadmin", "-debug"]
