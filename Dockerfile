...
CMD ["java", "-Xmx1024m", "-jar", "/datacrow/dc-server/datacrow-server.jar", "-dir:/datacrow/dc-server", "-userdir:/datacrow/dc-server/data", "-port:9000", "-imageserverport:9001", "-webserverport:8080", "-credentials:admin/2xadmin", "-ip:0.0.0.0"]
